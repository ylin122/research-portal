...
- GitHub repo: https://github.com/ylin122/research-portal (git root at ~/projects/research-portal, app code in research-portal-app/ subdir)
- Local path: ~/projects/research-portal/research-portal-app
