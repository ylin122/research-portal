...
const SW_SUBSECTORS = {
  crm: { name: "CRM", fullName: "Customer Relationship Management", category: "Horizontal Applications", color: T_.blue,
    ...
    trends: "AI-powered lead scoring & forecasting. Conversational AI for service. Platform consolidation (CRM + marketing + service). Salesforce dominant at ~21% share.",
  },
  erp: { name: "ERP", fullName: "Enterprise Resource Planning", category: "Horizontal Applications", color: T_.blue,
  ...
  hcm: { name: "HCM", fullName: "Human Capital Management", category: "Horizontal Applications", color: T_.blue,
  ...
  collab: { name: "Collaboration & Productivity", fullName: "Collaboration, Communication & Productivity", category: "Horizontal Applications", color: T_.blue,
  ...
  bi: { name: "BI & Analytics", fullName: "Business Intelligence & Analytics", category: "Horizontal Applications", color: T_.blue,
  ...
  scm: { name: "SCM", fullName: "Supply Chain Management", category: "Horizontal Applications", color: T_.blue,
  ...
  mktg: { name: "Marketing & AdTech", fullName: "Marketing Technology & AdTech", category: "Horizontal Applications", color: T_.blue,
  ...
  healthit: { name: "Healthcare IT", fullName: "Healthcare Information Technology", category: "Vertical Applications", color: T_.purple,
    tam: "$55B+ (2025)", growth: "~12-15% CAGR", icon: "🏥",
    ...
    trends: "AI for clinical documentation (ambient listening). Interoperability mandates (FHIR). Epic dominates US hospitals (~55% of beds). Cloud migration of legacy EHR.",
  },
  fintech: { name: "Fintech / Financial Software", fullName: "Financial Technology & Banking Software", category: "Vertical Applications", color: T_.purple,
  ...
  legaltech: { name: "Legal Tech", fullName: "Legal Technology", category: "Vertical Applications", color: T_.purple,
  ...
  construction: { name: "Construction Tech", fullName: "Construction & Real Estate Technology", category: "Vertical Applications", color: T_.purple,
  ...
  edtech: { name: "EdTech", fullName: "Education Technology", category: "Vertical Applications", color: T_.purple,
  ...
  cloud: { name: "Cloud Platforms", fullName: "Cloud Infrastructure & Platform Services (IaaS/PaaS)", category: "Infrastructure Software", color: T_.green,
  ...
  database: { name: "Databases", fullName: "Database Management Systems", category: "Infrastructure Software", color: T_.green,
  ...
  devops: { name: "DevOps & CI/CD", fullName: "Developer Tools, DevOps & CI/CD", category: "Infrastructure Software", color: T_.green,
  ...
  observability: { name: "Observability", fullName: "Monitoring, Observability & APM", category: "Infrastructure Software", color: T_.green,
  ...
  containers: { name: "Containers & Orchestration", fullName: "Containers, Orchestration & Virtualization", category: "Infrastructure Software", color: T_.green,
  ...
  endpoint: { name: "Endpoint Security", fullName: "Endpoint Detection & Response (EDR/XDR)", category: "Security Software", color: T_.red,
  ...
  network: { name: "Network Security", fullName: "Network Security & SASE/ZTNA", category: "Security Software", color: T_.red,
  ...
  iam: { name: "Identity & Access (IAM)", fullName: "Identity & Access Management", category: "Security Software", color: T_.red,
  ...
  mlplatform: { name: "ML Platforms", fullName: "Machine Learning Platforms & MLOps", category: "AI / ML Software", color: T_.amber,
  ...
  aiapps: { name: "AI Applications", fullName: "AI-Native Applications & Copilots", category: "AI / ML Software", color: T_.amber,
...
const TAXONOMY = [
  { key: "horizontal", label: "Horizontal Applications", color: T_.blue, icon: "📱", children: ["crm","erp","hcm","collab","bi","scm","mktg"] },
  { key: "vertical", label: "Vertical Applications", color: T_.purple, icon: "🏗️", children: ["healthit","fintech","legaltech","construction","edtech"] },
  { key: "infra", label: "Infrastructure Software", color: T_.green, icon: "🖥️", children: ["cloud","database","devops","observability","containers"] },
  { key: "middleware", label: "Middleware & Integration", color: "#0EA5E9", icon: "🔗", children: ["ipaas","etl","api"] },
  { key: "security", label: "Security Software", color: T_.red, icon: "🛡️", children: ["endpoint","network","iam"] },
  { key: "aiml", label: "AI / ML Software", color: T_.amber, icon: "🧠", children: ["mlplatform","aiapps"] },
];

const VALUE_CHAIN = [
  { label: "Cloud & Hardware", color: T_.textGhost, icon: "🖥️", desc: "Physical infrastructure",
  ...
  { label: "Infrastructure SW", color: T_.green, icon: "⚙️", desc: "Run & manage workloads",
  ...
  { label: "Application SW", color: T_.blue, icon: "📱", desc: "Business logic & workflows",
  ...
  { label: "Vertical Apps", color: T_.purple, icon: "🏗️", desc: "Industry-specific software",
...
export default function Primer({ initialTab }) {
  ...
  return (
    <div style={{ flex: 1, padding: "36px 52px", overflowY: "auto", fontFamily: FONT }}>
      {/* Sub-tabs */}
      <TabBar tabs={PRIMER_SECTOR_TABS} active={subTab} onChange={setSubTab} />

      {subTab === "software" && (
        <div>
          <div style={{ marginBottom: 24 }}>
            <div style={{ fontSize: 24, fontWeight: 700, color: T_.text, letterSpacing: "-0.5px" }}>Software Industry Primer</div>
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ marginTop: 10, background: `${T_.red}12`, border: `1px dashed ${T_.red}44`, borderRadius: 6, padding: "8px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                <span style={{ fontSize: 14 }}>🛡️</span>
                <span style={{ fontSize: 13, fontWeight: 700, color: T_.red }}>Security — Spans All Layers</span>
              </div>
            ...
            <div style={{ marginTop: 4, background: `${T_.amber}12`, border: `1px dashed ${T_.amber}44`, borderRadius: 6, padding: "8px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                <span style={{ fontSize: 14 }}>🧠</span>
                <span style={{ fontSize: 13, fontWeight: 700, color: T_.amber }}>AI / ML — Transforming Every Layer</span>
              </div>
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                { name: "Consumption / Usage-Based", color: T_.blue, icon: "📊",
                ...
                { name: "Perpetual License + Maintenance", color: T_.amber, icon: "📜",
                ...
                { name: "Transaction / Per-Unit Fees", color: T_.purple, icon: "💳",
                ...
                { name: "Freemium / Open Source + Commercial", color: T_.red, icon: "🆓",
      ...
      {subTab === "semis" && (() => {
        ...
        const SEMI_TAX = [
          { key: "edaip", label: "EDA & Silicon IP", color: T_.amber, icon: "🖊️", children: ["eda", "ip"] },
          { key: "logic", label: "Logic & Compute", color: T_.blue, icon: "💎", children: ["gpu", "cpu", "asic", "fpga"] },
          { key: "memory", label: "Memory", color: "#06B6D4", icon: "⚡", children: ["dram", "hbm", "nand"] },
          { key: "equip", label: "Equipment", color: T_.red, icon: "⚙️", children: ["litho", "etch", "inspect"] },
          { key: "pkg", label: "Packaging & Test", color: T_.purple, icon: "📦", children: ["advpkg"] },
        ...
        <div>
          <div style={{ marginBottom: 24 }}>
            <div style={{ fontSize: 24, fontWeight: 700, color: T_.text, letterSpacing: "-0.5px" }}>Semiconductor Industry Primer</div>
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ fontSize: 13, color: T_.textDim, marginBottom: 20 }}>From design tools through to end markets. Each stage depends on the one to its left. ~$790B industry (2025).</div>
            <div style={{ display: "flex", alignItems: "stretch", gap: 0 }}>
              {[
                { label: "EDA & IP", color: T_.amber, icon: "🖊️", desc: "Design tools & silicon IP", rows: [{ sub: "EDA Tools", ex: "Synopsys, Cadence, Siemens EDA" }, { sub: "IP Cores", ex: "Arm, Synopsys IP, Cadence IP" }, { sub: "Verification", ex: "Synopsys, Cadence, Ansys" }], buyers: "Chip designers (fabless, IDMs)" },
                { label: "Chip Design", color: T_.blue, icon: "💎", desc: "Fabless & IDM designers", rows: [{ sub: "Logic / GPU", ex: "NVIDIA, AMD, Qualcomm, Apple" }, { sub: "Memory", ex: "Samsung, SK Hynix, Micron" }, { sub: "Analog", ex: "TI, ADI, NXP, Infineon" }, { sub: "Custom ASIC", ex: "Broadcom, Marvell, Google" }], buyers: "OEMs, hyperscalers, auto, mobile" },
                { label: "Equipment", color: T_.red, icon: "⚙️", desc: "Machines that make chips", rows: [{ sub: "Lithography", ex: "ASML (monopoly: EUV)" }, { sub: "Etch & Dep", ex: "Lam Research, Applied Materials" }, { sub: "Inspection", ex: "KLA, Onto Innovation" }, { sub: "Test", ex: "Teradyne, Advantest" }], buyers: "Foundries, IDMs, memory fabs" },
                { label: "Foundry / Fab", color: T_.green, icon: "🏭", desc: "Manufacturing the silicon", rows: [{ sub: "Leading Edge", ex: "TSMC (~70% share), Samsung" }, { sub: "Mature Nodes", ex: "GlobalFoundries, UMC, SMIC" }, { sub: "Memory Fab", ex: "Samsung, SK Hynix, Micron" }], buyers: "Fabless designers (NVDA, AMD)" },
                { label: "Packaging & Test", color: T_.purple, icon: "📦", desc: "Assembly & final test", rows: [{ sub: "Advanced", ex: "TSMC CoWoS, Intel Foveros" }, { sub: "OSAT", ex: "ASE, Amkor, JCET" }, { sub: "Substrates", ex: "Ibiden, Shinko, Unimicron" }], buyers: "Foundries, fabless (final assembly)" },
            ...
            <div style={{ marginTop: 4, background: `${T_.amber}12`, border: `1px dashed ${T_.amber}44`, borderRadius: 6, padding: "8px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}><span style={{ fontSize: 14 }}>🌏</span><span style={{ fontSize: 13, fontWeight: 700, color: T_.amber }}>Geopolitics & Trade — Shapes the Entire Industry</span></div>
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {[
                { name: "Data Center / AI", pct: 30, rev: "$180B+", color: T_.blue, growth: "~25-30% CAGR", drivers: "AI training & inference GPUs, HBM, networking ASICs, AI accelerators. Hyperscaler capex driving unprecedented demand", top: "NVIDIA, AMD, Broadcom, Marvell, Intel" },
                { name: "Mobile", pct: 22, rev: "$130B+", color: T_.purple, growth: "~5-7% CAGR", drivers: "Smartphone SoCs, modems, RF front-end, power management. AI on-device features driving upgrade cycles", top: "Qualcomm, MediaTek, Apple, Skyworks" },
                ...
                { name: "Automotive", pct: 14, rev: "$85B+", color: T_.green, growth: "~12-15% CAGR", drivers: "ADAS/self-driving, EV power semis, infotainment. $ content per vehicle rising from $500 → $1,500+", top: "Infineon, NXP, ON Semi, TI, STMicro" },
                { name: "Industrial", pct: 12, rev: "$70B+", color: T_.amber, growth: "~8-10% CAGR", drivers: "Factory automation, power grid, renewables, robotics, medical devices, defense", top: "TI, ADI, STMicro, Microchip, Renesas" },
              ].map(m => (
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                { name: "Chip Sales (Fabless)", color: T_.blue, icon: "💎",
                ...
                { name: "IP Licensing & Royalties", color: T_.amber, icon: "📜",
                ...
                { name: "EDA Software (Subscription + License)", color: T_.green, icon: "🖊️",
                  ...
                  economics: "Gross margins: 85-90%. Subscription revenue is ~90%+ recurring. Revenue grows with semiconductor R&D spending (which grows 8-12% annually). Near-monopoly pricing power — Synopsys + Cadence ≈ 61% combined (SNPS ~31%, CDNS ~30%); Big Three with Siemens EDA (~13%) ≈ 74%",
                ...
                { name: "Foundry Manufacturing (Per-Wafer)", color: T_.red, icon: "🏭",
                  ...
                  examples: "TSMC (~70% foundry market share, ~$122B revenue), Samsung Foundry (~15%), GlobalFoundries (~7%), UMC, SMIC (China)",
                ...
                { name: "Equipment Sales + Service", color: T_.purple, icon: "⚙️",
      ...
      {subTab === "digiinfra" && (() => {
        const DI_SUBS = {
          hyperscale: { name: "Hyperscale Cloud", fullName: "Hyperscale Cloud Data Centers", category: "Cloud Infrastructure", color: T_.blue,
            tam: "$250B+ (2025)", growth: "~20-22% CAGR", icon: "☁️",
          ...
          neocloud: { name: "Neoclouds / GPU Cloud", fullName: "Specialized AI Cloud Infrastructure", category: "Cloud Infrastructure", color: T_.blue,
          ...
          dcbuilders: { name: "Data Center Builders", fullName: "AI Data Center Design, Build & Lease", category: "Data Center Real Estate", color: T_.green,
          ...
          colocation: { name: "Colocation / Data Center REITs", fullName: "Enterprise Colocation & Data Center REITs", category: "Data Center Real Estate", color: T_.green,
          ...
          power: { name: "Power & Energy", fullName: "Data Center Power Infrastructure", category: "Power & Cooling", color: T_.amber,
          ...
          cooling: { name: "Cooling & Thermal", fullName: "Data Center Cooling Solutions", category: "Power & Cooling", color: T_.amber,
          ...
          gpuchips: { name: "AI Chips & Accelerators", fullName: "GPUs, ASICs & AI Accelerators", category: "Silicon", color: T_.red,
        ...
        const DI_TAX = [
          { key: "cloud", label: "Cloud Infrastructure", color: T_.blue, icon: "☁️", children: ["hyperscale","neocloud"] },
          { key: "dcre", label: "Data Center Real Estate", color: T_.green, icon: "🏗️", children: ["dcbuilders","colocation"] },
          { key: "power", label: "Power & Cooling", color: T_.amber, icon: "⚡", children: ["power","cooling"] },
          { key: "connect", label: "Networking & Silicon", color: "#0EA5E9", icon: "🌐", children: ["networking","gpuchips"] },
        ];
        const DI_CHAIN = [
          { label: "Silicon", color: T_.red, icon: "🧠", desc: "AI chips & accelerators",
          ...
          { label: "Power & Cooling", color: T_.amber, icon: "⚡", desc: "Energy infrastructure",
          ...
          { label: "DC Builders", color: T_.green, icon: "🏗️", desc: "Build & lease facilities",
          ...
          { label: "Cloud Platforms", color: T_.blue, icon: "☁️", desc: "Compute as a service",
        ...
        <div>
          <div style={{ marginBottom: 24 }}>
            <div style={{ fontSize: 24, fontWeight: 700, color: T_.text, letterSpacing: "-0.5px" }}>Digital Infrastructure Primer</div>
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                { name: "Cloud Consumption (IaaS/PaaS)", color: T_.blue, icon: "☁️",
                ...
                { name: "Long-Term Data Center Leasing", color: T_.green, icon: "🏗️",
                ...
                { name: "GPU-as-a-Service (Neocloud)", color: T_.purple, icon: "⚡",
                ...
                { name: "Managed Services (Recurring)", color: T_.amber, icon: "🖥️",
      ...
      {subTab === "itservices" && (() => {
        const IT_SUBS = {
          consulting: { name: "IT Consulting", fullName: "IT Strategy & Digital Transformation Consulting", category: "Consulting", color: T_.blue,
          ...
          var: { name: "VARs / IT Solutions", fullName: "Value-Added Resellers & IT Solutions Providers", category: "Solutions", color: T_.green,
          ...
          managed: { name: "Managed Services", fullName: "Managed IT Services & Outsourcing", category: "Managed Services", color: T_.purple,
          ...
          msp: { name: "MSP Software", fullName: "Software for Managed Service Providers", category: "MSP Ecosystem", color: T_.amber,
        ...
        const IT_TAX = [
          { key: "consult", label: "Consulting & Implementation", color: T_.blue, icon: "💼", children: ["consulting"] },
          { key: "solutions", label: "Solutions & Integration", color: T_.green, icon: "🔧", children: ["var"] },
          { key: "mgd", label: "Managed Services & Outsourcing", color: T_.purple, icon: "🖥️", children: ["managed","msp"] },
          { key: "dist", label: "Distribution", color: "#0EA5E9", icon: "📦", children: ["distribution"] },
        ];
        return (
        <div>
          <div style={{ marginBottom: 24 }}><div style={{ fontSize: 24, fontWeight: 700, color: T_.text, letterSpacing: "-0.5px" }}>IT Services Primer</div><div style={{ fontSize: 14, color: T_.textDim, marginTop: 4 }}>Consulting, VARs, managed services, MSP ecosystem, and distribution</div></div>
          {/* Value Chain */}
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", alignItems: "stretch", gap: 0 }}>
              {[
                { label: "Technology Vendors", color: T_.textGhost, icon: "🏭", desc: "Build the products",
                ...
                { label: "VARs & Integrators", color: T_.green, icon: "🔧", desc: "Design & deploy solutions",
                ...
                { label: "Consulting", color: T_.blue, icon: "💼", desc: "Strategy & implementation",
                ...
                { label: "Managed Services", color: T_.purple, icon: "🖥️", desc: "Ongoing operations",
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                { name: "Product Resale (VAR)", color: T_.textGhost, icon: "📦",
                ...
                { name: "Professional Services (Project-Based)", color: T_.blue, icon: "💼",
                ...
                { name: "Managed IT Services (Recurring)", color: T_.green, icon: "🔄",
                ...
                { name: "MSP Software (SaaS for MSPs)", color: T_.amber, icon: "🛠️",
      ...
      {subTab === "healthit" && (() => {
        const HI_SUBS = {
          ehr: { name: "EHR / EMR", fullName: "Electronic Health Records", category: "Clinical Systems", color: T_.blue,
          ...
          rcm: { name: "Revenue Cycle Management", fullName: "Healthcare RCM Technology & Services", category: "Financial Operations", color: T_.green,
          ...
          payerint: { name: "Payer / Claims Technology", fullName: "Health Insurance & Claims Processing", category: "Payer Technology", color: T_.purple,
          ...
          ltpac: { name: "Post-Acute / LTPAC", fullName: "Long-Term & Post-Acute Care Technology", category: "Post-Acute", color: T_.amber,
          ...
          workforce: { name: "Healthcare Workforce", fullName: "Clinical Workforce Management", category: "Operations", color: T_.red,
        ...
        const HI_TAX = [
          { key: "clinical", label: "Clinical Systems", color: T_.blue, icon: "🏥", children: ["ehr"] },
          { key: "financial", label: "Financial Operations", color: T_.green, icon: "💰", children: ["rcm","payerint"] },
          { key: "postacute", label: "Post-Acute Care", color: T_.amber, icon: "🏠", children: ["ltpac"] },
          { key: "ops", label: "Operations & Workforce", color: T_.red, icon: "👩‍⚕️", children: ["workforce"] },
        ];
        return (
        <div>
          <div style={{ marginBottom: 24 }}><div style={{ fontSize: 24, fontWeight: 700, color: T_.text, letterSpacing: "-0.5px" }}>Healthcare IT Primer</div><div style={{ fontSize: 14, color: T_.textDim, marginTop: 4 }}>EHR, revenue cycle, payer technology, post-acute care, and workforce</div></div>
          {/* Value Chain */}
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", alignItems: "stretch", gap: 0 }}>
              {[
                { label: "Clinical Systems", color: T_.blue, icon: "🏥", desc: "Capture clinical data",
                ...
                { label: "Revenue Cycle", color: T_.green, icon: "💰", desc: "Turn care into revenue",
                ...
                { label: "Payer Technology", color: T_.purple, icon: "📋", desc: "Adjudicate & pay claims",
                ...
                { label: "Data & Analytics", color: T_.amber, icon: "📊", desc: "Insights & optimization",
                ...
                { label: "Workforce & Ops", color: T_.red, icon: "👩‍⚕️", desc: "Staff & operate",
            ...
            <div style={{ marginTop: 10, background: `${T_.blue}12`, border: `1px dashed ${T_.blue}44`, borderRadius: 6, padding: "8px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}><span style={{ fontSize: 14 }}>🔗</span><span style={{ fontSize: 13, fontWeight: 700, color: T_.blue }}>Interoperability — Connects All Systems</span></div>
              <div style={{ fontSize: 11, color: T_.textDim }}>FHIR/HL7 standards · HIEs · TEFCA framework · Epic Care Everywhere · CommonWell</div>
            </div>
            <div style={{ fontSize: 11, color: T_.textGhost, marginTop: 12, fontStyle: "italic" }}>US healthcare is a $4.5T industry. ~25% of spend goes to administration. Epic dominates hospitals (~55% of beds); the rest of the ecosystem is highly fragmented.</div>
          </div>
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                { name: "EHR / Clinical SaaS (Per-Patient/Per-Provider)", color: T_.blue, icon: "🏥",
                ...
                { name: "RCM Outsourcing (Percentage of Collections)", color: T_.green, icon: "💰",
                ...
                { name: "RCM Technology (SaaS + Transaction)", color: T_.purple, icon: "💳",
                ...
                { name: "Payment Integrity (Savings-Based)", color: T_.amber, icon: "🔍",
                ...
                { name: "Government Health IT (Long-Term Contracts)", color: T_.red, icon: "🏛️",
      ...
      {subTab === "internet" && (() => {
        const IN_SUBS = {
          hosting: { name: "Hosting & Domains", fullName: "Web Hosting, Domains & Website Builders", category: "Web Infrastructure", color: T_.blue,
          ...
          marketplace: { name: "Marketplaces & Directories", fullName: "Vertical Marketplaces & Directory Platforms", category: "Marketplaces", color: T_.green,
          ...
          consumersec: { name: "Consumer Security", fullName: "Consumer Cybersecurity & Identity Protection", category: "Consumer", color: T_.red,
          ...
          emailmktg: { name: "Email & SMB Marketing", fullName: "Email Marketing & SMB Digital Marketing", category: "Marketing", color: T_.amber,
          ...
          adtech: { name: "AdTech & Mobile", fullName: "Digital Advertising Technology & Mobile Marketing", category: "Advertising", color: T_.purple,
        ...
        const IN_TAX = [
          { key: "webinfra", label: "Web Infrastructure", color: T_.blue, icon: "🌐", children: ["hosting"] },
          { key: "mktp", label: "Marketplaces & Directories", color: T_.green, icon: "🏪", children: ["marketplace"] },
          { key: "consumer", label: "Consumer Products", color: T_.red, icon: "🔐", children: ["consumersec"] },
          { key: "mktg", label: "Marketing & Advertising", color: T_.amber, icon: "📧", children: ["emailmktg","adtech"] },
        ];
        return (
        <div>
          <div style={{ marginBottom: 24 }}><div style={{ fontSize: 24, fontWeight: 700, color: T_.text, letterSpacing: "-0.5px" }}>Internet Primer</div><div style={{ fontSize: 14, color: T_.textDim, marginTop: 4 }}>Hosting, marketplaces, consumer security, email marketing, and adtech</div></div>
          {/* Value Chain */}
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", alignItems: "stretch", gap: 0 }}>
              {[
                { label: "Infrastructure", color: T_.textGhost, icon: "🌐", desc: "Enable online presence",
                ...
                { label: "Build & Create", color: T_.blue, icon: "🛠️", desc: "Create web presence",
                ...
                { label: "Content & Commerce", color: T_.green, icon: "🏪", desc: "Attract users & sell",
                ...
                { label: "Engage & Market", color: T_.amber, icon: "📧", desc: "Acquire & retain users",
                ...
                { label: "Monetize", color: T_.purple, icon: "💰", desc: "Ads, subs & transactions",
            ...
            <div style={{ marginTop: 10, background: `${T_.red}12`, border: `1px dashed ${T_.red}44`, borderRadius: 6, padding: "8px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}><span style={{ fontSize: 14 }}>🤖</span><span style={{ fontSize: 13, fontWeight: 700, color: T_.red }}>AI Disruption Risk — Across All Layers</span></div>
          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                { name: "Domain Registration & Hosting (Subscription)", color: T_.blue, icon: "🌐",
                ...
                { name: "Advertising & Lead Generation", color: T_.amber, icon: "📣",
                ...
                { name: "Consumer Security (Auto-Renewing Subscription)", color: T_.red, icon: "🔐",
                ...
                { name: "SMB Marketing SaaS (Per-Contact Subscription)", color: T_.green, icon: "📧",
                ...
                { name: "Mobile Ad-Tech (Performance-Based)", color: T_.purple, icon: "📱",
      ...
      {subTab === "education" && (() => {
        const ED_SUBS = {
          k12sis: { name: "K-12 SIS & Admin", fullName: "K-12 Student Information Systems & Administration", category: "K-12 Software", color: T_.blue,
          ...
          k12lms: { name: "K-12 LMS & Curriculum", fullName: "K-12 Learning Management & Digital Curriculum", category: "K-12 Software", color: T_.blue,
          ...
          higher: { name: "Higher Ed Software", fullName: "Higher Education Technology", category: "Higher Education", color: T_.purple,
          ...
          corporate: { name: "Corporate L&D", fullName: "Corporate Learning & Development", category: "Corporate Training", color: T_.green,
          ...
          opm: { name: "OPM & Online Learning", fullName: "Online Program Management & Direct-to-Consumer Learning", category: "Online Learning", color: T_.amber,
          ...
          edtic: { name: "EdTech Infrastructure", fullName: "Education IT Infrastructure & Services", category: "Infrastructure", color: T_.textGhost,
        ...
        const ED_TAX = [
          { key: "k12", label: "K-12 Education", color: T_.blue, icon: "🏫", children: ["k12sis","k12lms"] },
          { key: "highered", label: "Higher Education", color: T_.purple, icon: "🎓", children: ["higher"] },
          { key: "corplearn", label: "Corporate Learning & Development", color: T_.green, icon: "💼", children: ["corporate"] },
          { key: "online", label: "Online Learning & OPM", color: T_.amber, icon: "🌐", children: ["opm"] },
          { key: "assessments", label: "Assessment & Testing", color: "#0EA5E9", icon: "📝", children: ["assess"] },
          { key: "infra", label: "Education IT Infrastructure", color: T_.textGhost, icon: "🖥️", children: ["edtic"] },
        ];
        const ED_REVMODELS = [
          { model: "SaaS Subscription (Per-Student/Per-Seat)", desc: "Dominant model in K-12 and higher ed SIS/LMS. Districts and universities pay per-student or per-user annually. High retention due to switching costs. PowerSchool, Ellucian, Canvas.", color: T_.blue },
          { model: "Freemium / Ad-Supported", desc: "Consumer and K-12 platforms offer free tiers (Google Classroom, Khan Academy, Duolingo) to build adoption, then monetize via premium features, enterprise sales, or advertising.", color: T_.green },
          { model: "Revenue Share (OPM)", desc: "Online program managers take 40-60% of tuition revenue in exchange for marketing, enrollment, platform, and student support. Model under DOE scrutiny and university pushback. 2U, Keypath, Noodle.", color: T_.amber },
          { model: "Content Licensing & Marketplace", desc: "Publishers and content platforms sell or license digital curriculum, textbooks, and training content. Moving from one-time purchase to subscription. Pearson, McGraw-Hill, Cengage, Udemy, LinkedIn Learning.", color: T_.purple },
          ...
          { model: "Government-Funded / Grant-Dependent", desc: "Significant portion of education spending is government-funded (E-Rate, ESSER, Title I, Pell Grants). Budget cycles and policy changes create demand volatility. ESSER cliff in 2024-2025 is a near-term headwind.", color: T_.red },
        ];
        ...
        return (
        <div>
          <div style={{ marginBottom: 24 }}><div style={{ fontSize: 24, fontWeight: 700, color: T_.text, letterSpacing: "-0.5px" }}>Education & Education Services Primer</div><div style={{ fontSize: 14, color: T_.textDim, marginTop: 4 }}>K-12, higher ed, corporate learning, online platforms, assessment, and infrastructure</div></div>
          {/* Value Chain */}
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", alignItems: "stretch", gap: 0 }}>
              {[
                { label: "Infrastructure & Devices", color: T_.textGhost, icon: "🖥️", desc: "Physical and digital foundation",
                ...
                { label: "Platform & Admin", color: T_.blue, icon: "🏫", desc: "Systems of record",
                ...
                { label: "Content & Curriculum", color: T_.purple, icon: "📚", desc: "What students learn",
                ...
                { label: "Online & OPM", color: T_.amber, icon: "🌐", desc: "Alternative delivery",
                ...
                { label: "Learners & Employers", color: T_.green, icon: "👥", desc: "End consumers",
            ...
            <div style={{ marginTop: 10, background: `${T_.red}12`, border: `1px dashed ${T_.red}44`, borderRadius: 6, padding: "8px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                <span style={{ fontSize: 14 }}>⚠️</span>
                <span style={{ fontSize: 13, fontWeight: 700, color: T_.red }}>ESSER Cliff — Near-Term Budget Headwind</span>
              </div>
            ...
            <div style={{ marginTop: 4, background: `${T_.amber}12`, border: `1px dashed ${T_.amber}44`, borderRadius: 6, padding: "8px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                <span style={{ fontSize: 14 }}>🧠</span>
                <span style={{ fontSize: 13, fontWeight: 700, color: T_.amber }}>AI — Disrupting Content, Assessment & Tutoring</span>
              </div>
