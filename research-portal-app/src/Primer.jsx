          ...
          <div style={{ background: T_.bgPanel, borderRadius: 10, border: `1px solid ${T_.border}`, padding: 24, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", alignItems: "stretch", gap: 0 }}>
              {[
                ...
                { label: "Foundry / Fab", color: "#10B981", icon: "🏭", desc: "Manufacturing the silicon", rows: [{ sub: "Leading Edge", ex: "TSMC (~70% share), Samsung" }, { sub: "Mature Nodes", ex: "GlobalFoundries, UMC, SMIC" }, { sub: "Memory Fab", ex: "Samsung, SK Hynix, Micron" }], buyers: "Fabless designers (NVDA, AMD)" },
