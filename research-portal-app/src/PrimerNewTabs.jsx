  ...
  if (subTab === "comms") {
    const SUBS = {
      ...
      satellite: { name: "Satellite & LEO", fullName: "Satellite Communications & Low Earth Orbit Constellations", category: "Infrastructure", color: "#06B6D4",
        ...
        trends: "Starlink at 4M+ subscribers, dominant in LEO. Direct-to-device (D2D) partnerships with carriers. Amazon Kuiper launching 2025-2026. GEO operators consolidating (SES-Intelsat). Government/defense as growth market",
      },
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            { name: "Infrastructure Leasing (Towers & Fiber)", color: "#F59E0B", icon: "🗼",
              ...
              examples: "American Tower (225K+ global towers), Crown Castle (40K US towers + fiber), SBA Communications (39K towers), Cellnex (115K European towers)",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            { name: "Franchise Model", color: "#F59E0B", icon: "🏪",
              ...
              economics: "Royalty revenue is nearly 100% margin. Franchise systems have 80-90% gross margins. Capital-light — franchisees fund unit growth. McDonald's: 93% franchised, ~$25B system-wide sales generates ~$14B franchisor revenue at 65%+ operating margin",
              examples: "McDonald's (93% franchised), Marriott/Hilton (98%+ franchised), Yum! Brands, Restaurant Brands International, Wingstop (98% franchised), Planet Fitness",
  ...
  if (subTab === "financials") {
    const SUBS = {
      ...
      am: { name: "Asset Management", fullName: "Asset Management & Wealth Management", category: "Asset Management", color: "#8B5CF6",
        ...
        keyPlayers: ["BlackRock ($11T+ AUM)", "Vanguard ($9T+)", "Fidelity", "State Street Global", "T. Rowe Price", "PIMCO (Allianz)", "Capital Group (American Funds)", "Invesco"],
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            { name: "Fee-Based (Advisory / AUM)", color: "#10B981", icon: "📊",
              ...
              examples: "Goldman Sachs (advisory + trading), BlackRock ($11T AUM, ~25bps avg fee), Morgan Stanley Wealth Management, Evercore (pure advisory), Apollo (alternatives)",
  ...
  if (subTab === "fintech") {
    const SUBS = {
      ...
      wealthtech: { name: "WealthTech & Robo-Advisory", fullName: "Digital Wealth Management & Robo-Advisors", category: "Investing", color: "#8B5CF6",
        ...
        keyPlayers: ["Robinhood", "Wealthfront (UBS acquired)", "Betterment", "Schwab Intelligent Portfolios", "Public.com", "Titan", "Carta (private markets)", "AngelList"],
