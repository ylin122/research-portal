...
const ASC_STANDARDS = [
  ...
  },
  {
    ...
    effective: "ASC 450: Original SFAS 5 (1975). ASC 460: FASB Interpretation 45 (Nov 2002).",
    ...
    caseStudies: [
      {
        ...
        year: "1998\u20132002",
        amount: "$2.3B in hidden Rigas family debt",
        scheme: "Adelphia, the fifth-largest US cable company, was controlled by the Rigas family (founder John Rigas and sons Timothy, Michael, and James). The Rigas family used Adelphia's borrowing capacity to fund personal purchases totaling $2.3B+: luxury condominiums in Manhattan, a golf course in Pennsylvania, timberlands, the Buffalo Sabres NHL franchise, and private aircraft. The family borrowed through off-balance-sheet partnerships (co-borrowing facilities) that were guaranteed by Adelphia but not disclosed on Adelphia's balance sheet or in its SEC filings. Adelphia also overstated its subscriber counts by 20%+ by including connections that didn't generate revenue and inflated revenue through internal accounting adjustments. The family treated the public company as a family piggy bank, moving cash between Adelphia and family entities freely.",
        unraveled: "In March 2002, Adelphia disclosed $2.3B in off-balance-sheet co-borrowings guaranteed by the company \u2014 debt the market didn't know existed. The disclosure came after an analyst noticed the co-borrowing footnote during the company's year-end earnings call. The stock fell 50% immediately. An internal investigation revealed the full extent of family borrowings and the subscriber count inflation. The SEC and DOJ opened investigations within weeks.",
