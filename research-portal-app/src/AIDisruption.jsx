...
const TOP_DISRUPTED_CO = [
  { name: "Virtusa", reason: "Offshore IT services body shop selling developer headcount. AI makes each dev 2-3x productive, directly compressing billable hours demand. Thin margins limit ability to pivot", sector: "IT Services" },
  { name: "Thoughtworks", reason: "Premium IT consulting heavy on developer labor. AI code generation compresses project timelines and billable hours. Pyramid staffing model with junior devs most exposed", sector: "IT Services" },
  { name: "Xerox", reason: "Document processing and print services. OCR + LLMs automate document workflows. Print volumes in secular decline, services revenue tied to manual processing headcount", sector: "BPO / Document" },
  { name: "UST Global", reason: "IT services with offshore delivery. App dev, testing, and maintenance engagements face AI-driven labor compression. Per-FTE billing model directly threatened", sector: "IT Services" },
  { name: "Synechron", reason: "IT consulting for financial services. AI compresses discovery, analysis, and junior consultant work. Headcount-based billing under structural pressure", sector: "IT Services" },
  { name: "Perficient", reason: "Digital consultancy selling implementation hours. AI accelerates delivery — fewer billable hours per project. Competitors using AI tools deliver faster at lower cost", sector: "IT Consulting" },
  { name: "Skillsoft", reason: "Corporate L&D with static content library. AI generates personalized training at fraction of cost. Generic courses become commodity when AI creates on-demand learning", sector: "Education" },
  { name: "ZoomInfo", reason: "Sales data enrichment faces commoditization. AI tools scrape, synthesize, and enrich contact/company data natively. CRM AI features absorb standalone data products", sector: "Software" },
  { name: "Rackspace Technology", reason: "Managed hosting/services relying on NOC headcount for monitoring and incident response. AIOps automates basic operations. Margin pressure from AI-enabled competitors", sector: "Managed Services" },
  { name: "Liftoff Mobile", reason: "Smaller ad network competing against AI-powered walled gardens (Meta Advantage+, Google PMax). AI targeting advantages accrue to platforms with the most data", sector: "AdTech" },
];

const TOP_BENEFITED_CO = [
  { name: "CCC Intelligent Solutions", reason: "AI auto claims estimation expanding TAM. Image AI and automated adjudication make CCC more valuable to insurers. Current model directly benefits — more AI = more accuracy = more pricing power", sector: "Insurance Tech" },
  { name: "Proofpoint", reason: "AI-generated phishing more convincing and voluminous, directly increasing demand for AI-powered email security. Current business model is the solution to the AI threat problem", sector: "Cybersecurity" },
  { name: "Sophos", reason: "MDR and endpoint security benefit from AI-driven threat escalation. Managed detection model becomes more essential as attacks get more sophisticated. Broad SMB telemetry is a moat", sector: "Cybersecurity" },
  { name: "Darktrace", reason: "AI-native threat detection built on unsupervised ML. Growing attack surface from AI-powered threats directly expands addressable market. Self-learning model improves with scale", sector: "Cybersecurity" },
  { name: "SonarSource", reason: "More AI-generated code = more code to scan for quality and security. Every line Copilot/Cursor writes still needs SonarQube. Volume of code structurally increasing (Jevons')", sector: "DevOps" },
  { name: "Cotiviti", reason: "AI finds more payment integrity savings across $3T+ claims. More data analyzed = more waste/fraud identified. Current analytics model gets stronger with AI, not disrupted by it", sector: "Healthcare IT" },
  { name: "Veeam Software", reason: "AI-powered ransomware makes attacks more sophisticated, increasing urgency for modern backup/recovery. More threats = more protection demand. Cyber vault becoming table stakes", sector: "Data Protection" },
  { name: "Cloudera", reason: "Hybrid data platform for AI/ML workloads. Enterprise AI initiatives need data infrastructure that spans on-prem and cloud. Consumption scales with AI adoption", sector: "Data Infrastructure" },
  { name: "Precisely", reason: "AI is only as good as data quality — garbage in, garbage out. Every enterprise AI initiative starts with data integrity. Current data quality/integration business is prerequisite for AI", sector: "Data Infrastructure" },
  { name: "Qlik", reason: "BI with AI-powered analytics expanding user base. NLP querying democratizes data access. AI transforms Qlik from analyst tool to every-employee tool, expanding seats and usage", sector: "BI & Analytics" },
];
