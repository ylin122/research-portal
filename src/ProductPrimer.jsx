...
const PRODUCT_PRIMERS = {
  gpu: {
    label: "GPU",
    tagline: "AI accelerator GPU — silicon at the heart of the AI buildout. ~$30-70K ASP, ~$150-210B market 2026 (def-dependent), ~85% Nvidia / ~10% AMD share + custom ASIC remainder. The most supply-constrained product in the modern economy.",
    layers: [
