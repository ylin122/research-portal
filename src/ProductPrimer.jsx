...
const PRODUCT_PRIMERS = {
  gpu: {
    ...
    layers: [
      ...
      { label: "Packaging & Memory", items: [
        ...
        { name: "SK Hynix HBM", sub: "HBM3E leader · ~53-57% share · 2026 sold out", color: "#A855F7", link: "000660.KS", flag: "bottleneck" },
        { name: "Samsung HBM", sub: "HBM4 mass prod Sep 2025 (Pyeongtaek P3) · NVDA-qualified · 2026 sold out", color: T_.blue, link: "005930.KS", flag: "bottleneck" },
      ...
      { label: "Resources & Utilities", items: [
        ...
        { name: "Naphtha → propylene", sub: "Iran-war driven · ~67% spike (Mar–May 2026, $776→$1300/t) · Korea expects 90% pre-war supply for May", color: "#DC2626", flag: "bottleneck" },
    ...
    drivers: [
      ...
      { metric: "HBM3E / HBM4 capacity", current: "All 2026 supply sold out", target: "+30-50% in 2027", status: "constrained", note: "SK Hynix M15X first cleanroom pilot May 2026 (60K wpm by mid-27). Samsung HBM4 mass prod Sep 2025, NVDA-qualified. Micron ramping HBM3E + HBM4." },
  ...
  cpu: {
    ...
    layers: [
      ...
      { label: "Resources & Utilities", items: [
        ...
        { name: "Naphtha → propylene", sub: "Iran-war driven · ~67% spike (Mar–May 2026) · Korea expects 90% pre-war supply for May", color: "#DC2626", flag: "bottleneck" },
        { name: "Rare earths (Ga, Ge, Ne)", sub: "China dominance ~85% · Ga/Ge export ban suspended Nov 2025–Nov 2026", color: "#DC2626", flag: "concentration" },
  ...
  hbm: {
      ...
      rows: [
        {
          ...
          notes: "Sold out through 2026. Bandwidth is the moat. Only 3 makers globally.",
        },
        {
    ...
    layers: [
      { label: "Finished Product", items: [
        { name: "SK Hynix HBM", sub: "HBM3E leader · ~53-57% share (Q3 25) · M16 + M15X · 2026 sold out", color: "#A855F7", link: "000660.KS", flag: "bottleneck" },
        { name: "Samsung HBM", sub: "HBM4 mass prod Sep 2025 (P3/Pyeongtaek) · ~22% share, growing · 2026 sold out · NVDA-qualified", color: T_.blue, link: "005930.KS", flag: "bottleneck" },
        { name: "Micron HBM", sub: "HBM3E ramp · HBM4 next · Boise + Hiroshima · ~21% share · 2026 sold out", color: T_.amber, link: "MU", flag: "bottleneck" },
      ]},
      { label: "Design & IP", items: [
      ...
      { label: "DRAM Manufacturing", items: [
        ...
        { name: "SK Hynix M15X (Cheongju)", sub: "1st cleanroom pilot May 2026 · 60K wpm by mid-2027 · ~$15B / 20T won invest", color: "#A855F7", link: "000660.KS" },
        { name: "Samsung Pyeongtaek + Hwaseong", sub: "P3 line · HBM4 mass prod Sep 2025 · 1c node · catching SK Hynix", color: T_.blue, link: "005930.KS" },
      ...
      { label: "Resources & Utilities", items: [
        ...
        { name: "Naphtha → propylene", sub: "Iran-war driven · ~67% spike Mar-May 2026 · hits Korean fabs first · 90% pre-war May supply", color: "#DC2626", flag: "bottleneck" },
  ...
  nand: {
      ...
      rows: [
        {
          ...
          notes: "Samsung BM1743 122TB QLC + Solidigm D7-PS1010 122TB shipping. Fastest-growing NAND segment. 1-3 DWPD endurance.",
        },
        {
        ...
        },
        {
          ...
          notes: "232L mainstream (Samsung V8, Micron G9). SK Hynix 321L tested. QLC dominant in eSSD; PLC emerging.",
        },
        {
    ...
    layers: [
      { label: "Finished Product", items: [
        { name: "Samsung NAND/SSD", sub: "~33% NAND share · enterprise + client + UFS · BM1743 122TB QLC eSSD", color: T_.blue, link: "005930.KS" },
        { name: "SK Hynix + Solidigm", sub: "~20-22% combined · Solidigm = enterprise QLC leader · D7-PS1010 122TB", color: "#A855F7", link: "000660.KS" },
        { name: "Kioxia", sub: "~17-19% share · BiCS Flash · Japan IPO Oct 2024", color: T_.amber, link: "285A.T" },
        ...
        { name: "YMTC (China)", sub: "~5-7% share · Wuhan · capped by US export controls · Xtacking tech", color: "#DC2626", flag: "concentration" },
      ]},
      { label: "Design & IP", items: [
      ...
      { label: "SSD Controllers", items: [
        { name: "Marvell (enterprise)", sub: "Bravera + leading-edge eSSD controllers · ~40%+ eSSD merchant mkt", color: T_.green, link: "MRVL" },
        ...
        { name: "Silicon Motion", sub: "~30%+ client SSD controller · SM2508 PCIe Gen5", color: T_.amber, link: "SIMO" },
      ...
      { label: "Stacking & Layer Tech", items: [
        { name: "3D NAND layer count (232L → 300L+)", sub: "Samsung V8 (236L) · Micron G9 (232L) · SK Hynix 321L sampled · YMTC 232L", color: "#A855F7", flag: "bottleneck" },
      ...
      { label: "NAND Manufacturing", items: [
        ...
        { name: "Micron Singapore + Manassas", sub: "$24B Singapore expansion · +700K sq ft cleanroom · 2027 completion", color: T_.amber, link: "MU" },
        { name: "YMTC Wuhan (China)", sub: "Xtacking tech · capped by US export controls · ~5-7% global share", color: "#DC2626", flag: "concentration" },
      ]},
      { label: "Fab Equipment", items: [
      ...
      { label: "Resources & Utilities", items: [
        { name: "Helium", sub: "Qatar (~75% Asia imports) · NAND less helium-intensive than DRAM but still needed", color: "#DC2626", flag: "concentration" },
    ...
    drivers: [
      ...
      { metric: "HDD → QLC transition", current: "QLC 122TB eSSDs shipping (Samsung BM1743, Solidigm D7-PS1010)", target: "Accelerating 2026-2028", status: "ok", note: "$/GB gap narrowing. Power + density advantage compelling for hyperscalers. Material tailwind for NAND bit demand." },
      ...
      { metric: "China YMTC ramp / US export controls", current: "YMTC ~5-7% share, capped by US controls", target: "Status quo through 2028 absent policy shift", status: "ok", note: "US export controls limit YMTC fab equipment. Korean + Japanese makers benefit." },
    ],
    bottlenecks: [
      ...
      { node: "Helium", layer: "Resources & Utilities", supplier: "Qatar (~75% Asia imports), Algeria, US, Russia", leadTime: "Demand-elastic", relief: "Strategic reserves + Tanzania", beneficiaries: "Air Products, Linde. Impacts ALL semi fabs (less critical for NAND than DRAM)." },
    ],
  },
};
