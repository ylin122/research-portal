...
const UI_META = {
  ...
  'fact-check-reconciler':{ color: '#818CF8', usage: '@fact-check-reconciler src/Restructuring.jsx', mode: 'Read-only. Single-agent thorough fact-check; loads Sources tab as Tier-0 (extract → curated-source check → verify → dispute → reconcile).', sort: 1 },
